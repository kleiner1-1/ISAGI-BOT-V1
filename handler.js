...
global.dfail = (type, m, conn) => {
  ...
  const msg = {
    rowner: `\`\`\`『⚔️』El comando 〘 ${comando} 〙 Solo puede ser usado por los creadores del bot.\`\`\``,
    ...
    botAdmin: `\`\`\`『🚀』Para ejecutar el〘 ${comando} 〙 debo der administrador del grupo.\`\`\``,
    unreg: `\`\`\`⚽ El comando〘 ${comando} 〙Solo puede ser usado por los usuarios registrados, Registrarse\n\n_🌴 Utiliza_ : \n> » *#${verifyaleatorio} ${user2}.${edadaleatoria}*\`\`\``,
